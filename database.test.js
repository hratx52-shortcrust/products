...
test('getProducts returns products from page 3, 2 products per page', () => {
  expect.assertions(1);
  return expect(db.getProducts(3, 2)).resolves.toEqual(
    [
      {
        "id": 5,
...
test('getProduct returns product info with ID 9', () => {
  expect.assertions(1);
  return expect(db.getProduct(9)).resolves.toEqual(
    {
      "id": 9,
      "name": "Summer Shoes",
